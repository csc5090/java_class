         ...
         <table id="mJoin_t">
            ...
            <tr>
               ...
               <td><input name="mem_zip" id="mem_zip" size="3"
                  class="input_box" readonly value="${em.mem_zip}" />- <input
                  name="mem_zip2" id="mem_zip2" size="3" class="input_box" readonly
                  value="${em.mem_zip2}" /> <%-- readonly 속성은 읽기만 가능. --%> <input
                  type="button" value="우편검색" class="input_b" onclick="post_check();" /></td>
            </tr>
            <tr>
               <th>주소</th>
            ...
            <tr>
               ...
               <td><select name="mem_phone01" id="mem_phone01">
                  ...
                  class="input_box" value="${em.mem_phone02}" />-<input
                  name="mem_phone03" id="mem_phone03" size="4" maxlength="4"
                  class="input_box" value="${em.mem_phone03}" /> <%-- maxlength="4"로 지정하면 최대 4자까지만 입력가능 --%>
               </td>
            </tr>
            <tr>
               <th>전자우편</th>
               <td><input name="mail_id" id="mail_id" size="14"
                  class="input_box" value="${em.mail_id}" /> @<input
                  name="mail_domain" id="mail_domain" size="18" class="input_box"
                  readonly value="${em.mail_domain}" /> <select name="mail_list"
