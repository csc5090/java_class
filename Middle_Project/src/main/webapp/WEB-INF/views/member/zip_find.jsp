		...
		<table width="414" height="100" border="0" align="center"
			...
			<tr>
				<td bgcolor="f5ffea" align="center"><strong><font
						color="#466d1b"><span class="style1">[도로명 또는
								지번(읍.면.동.리)을 입력하고 '찾기'버튼을 누르세요!]</span></font></strong></td>
			</tr>
			<tr height="30">
						...
						<td bgcolor="f5ffea" height="30" align="center"><SELECT
							NAME="post_list" onchange="selectnow()">
								...
								<c:forEach var="addr2" items="${zipcodelist}">
									...
									<!-- addr2.zipcode에는 Zipcode2DTO 클래스의 getZipcode()메서드를 가져와 
             우편번호,addr.addr 에는 Zipcode2DTO 클래스의 getAddr()메서드를 가져와 시도 구군 동,
