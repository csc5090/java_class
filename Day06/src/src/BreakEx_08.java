...
public class BreakEx_08 {
	...
	public static void main(String[] args) {
		...
		while (true) {
			...
			if (menuNumber == 0) {
				System.out.print("여름음식 선택 메뉴판을 종료합니다.");
				break; // while 무한루프문 종료
			} else if (!(1 <= menuNumber && menuNumber <= 3)) {
				System.out.print("잘못된 메뉴번호를 선택했습니다.");
			...
			for (;;) {
				...
				switch (menuNumber) {
				case 1:
					System.out.println("밀면 가격 : " + moneyPrice);
					break;
				case 2:
					System.out.println("물냉면 가격 : " + moneyPrice);
					break;
				case 3:
					System.out.println("삼계탕 가격 : " + moneyPrice);
					break;
				}
